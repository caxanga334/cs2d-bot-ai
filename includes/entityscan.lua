...
function fai_scanforentity(id)
	...
	if vai_entityscan[id]<=0 then
		...
		-- mode check
		if vai_mode[id]~=4 and vai_mode[id]~=9 and vai_mode[id]~=20 and vai_mode[id]~=21 and vai_mode[id]~=22 and vai_mode[id]~=23 and vai_mode[id]~=24 and vai_mode[id]~=11 and vai_mode[id]~=12 and vai_mode[id]~=63 then
